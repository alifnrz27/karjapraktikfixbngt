<div class="w-full lg:w-1/2 p-4 mb-4 bg-white dark:bg-secondary rounded-lg h-full max-h-[2000px] overflow-auto">
    <div class="w-full self-center px-4 lg:w-1/2">
        <h1 class="text-base font-semibold text-primary dark:text-white md:text-xl">Daftar yang belum mengumpulkan hardcopy</h1>
    </div>
                        ...
                        <tbody>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="text-sm text-gray-900 font-light px-6 py-4 flex">
                                        <form action="/hardcopy/accept/{{ $s->user_id }}/{{ $s->id }}" method="post">
                                            @csrf
                                            <button type="submit">
