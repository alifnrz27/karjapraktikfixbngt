<section class="bg-gray-100 p-3 mb-5 dark:bg-dark">
    <div class="w-full p-4 bg-white dark:bg-secondary rounded-lg h-full max-h-[3000px] overflow-auto">
        <div class="w-full self-center px-4 flex justify-between">
            <h1 class="text-base font-semibold text-primary dark:text-white md:text-xl">Pengajuan berkas dari jurusan</h1>
        </div>
        <div class="flex flex-col">
            <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="overflow-hidden">
                        @if(count($replyLetters) == 0)
                        ...
                        <table class="min-w-full">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="text-sm text-gray-900 font-light px-6 py-4">
                                        <a target="_blank" href="{{ $s->from_major }}">Jurusan</a> || 
                                    ...
                                    <td class="text-sm text-gray-900 font-light px-6 py-4 flex">
                                        ...
                                        <div>
                                            ...
                                            <section id="decline-letter-{{ $s->user->username }}" class="fixed hidden w-full lg:w-4/12 p-3 mb-5 mx-auto my-auto left-0 dark:bg-dark top-0 shadow-lg bg-primary" style="margin: auto">
                                                <div class="w-full p-4 bg-white dark:bg-secondary rounded-lg h-full max-h-[1000px] overflow-auto">
                                                    <div class="w-full flex justify-between self-center px-4">
                                                        ...
                                                        <button onclick="sembunyiPopup('decline-letter-{{ $s->user->username }}')" class="text-base text-black">x</button>
                                                    </div>
                                                    
                                                    <section id="logbook" class="pt-36 pb-32 dark:bg-slate-900">
                                                        <div class="container">        
                                                            <form action="/job-training/submission-letter/decline/{{ $s->user->username }}/{{ $s->team_id }}" method="POST">
                                                                @csrf
