        ...
        @if(auth()->user()->active_id == 1)
            ...
            <div class="container">
                ...
                <div class="m-2 rounded-lg p-1">
                    <img src="/assets/images/icons/undraw_winners_re_wr1l.svg" class="mx-auto hover:opacity-50 transition duration-400" width="200px" alt="">
            ...
            <section id="student-register" class="w-full pt-36 pb-32 dark:bg-slate-900">
                <div class="container">
                    ...
                    <h1 class="text-base font-semibold text-primary md:text-xl mx-auto mb-4">{{ $descriptionSubmissionStatus->name }}</h1>
